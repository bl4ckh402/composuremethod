    ...
    <section className="py-12 my-8 bg-[#f6f3f2] rounded-3xl p-8 md:p-16 border-botanical flex flex-col items-center text-center relative overflow-hidden shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-left">
          <div className="font-mono-caps text-xs text-[#081d00] font-bold">Sarah Chen</div>
          <div className="font-mono-caps text-xs text-[#43483e]">Sr. Operations Lead, Meridian Health</div>
        </div>
      </div>
    </section>
  );
