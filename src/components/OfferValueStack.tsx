      ...
      >
        ...
        <div className="bg-white/8 rounded-2xl p-6 border border-white/10 backdrop-blur-sm space-y-1 relative z-10">
          <div className="flex justify-between items-center font-mono-caps text-[10px] text-[#b7f473] border-b border-white/12 pb-3 mb-3">
            <span>{offer.includedLabel}</span>
            <span>{offer.retailValueLabel}</span>
          </div>
          ...
          <div className="pt-4 border-t border-white/15 flex justify-between items-center">
            <span className="font-display text-sm md:text-base text-white font-bold">{offer.totalRetailValue}</span>
        ...
        <div className="text-center space-y-6 relative z-10">
          <div className="space-y-1">
            <span className="font-mono-caps text-xs text-white/60 uppercase">{offer.todayLabel}</span>
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-mono-caps text-xs text-[#b7f473] font-bold">{offer.currency}</div>
                  <div className="font-mono text-xs text-white/60">{offer.saveToday}</div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <span>{isMemberVerified ? t('offer.memberButton') : offer.nonMemberButton}</span>
